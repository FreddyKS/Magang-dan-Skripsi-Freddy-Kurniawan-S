                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    setInterval(showTime, 1);
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(!Auth::check()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="/grantadminaccess"><?php echo e(__('Admin Access')); ?></a>
                            </li>
                           <?php else: ?>
                           <?php endif; ?>
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                Welcome, <?php echo e(Session::get('name')); ?> <span class="caret"></span>
                                </a>
...
<?php /**PATH C:\Users\FKS\Desktop\Semester 7\Thesis\Thesis Application\Thesis\resources\views/layouts/app.blade.php ENDPATH**/ ?>