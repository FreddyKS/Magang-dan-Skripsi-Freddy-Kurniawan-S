    ...
    <body>
        <div class="flex-center position-ref full-height">
			...
			<?php if(Auth::check()): ?>
                        ...
                        <?php endif; ?>
                        <?php if(!(Auth::check())): ?>
                        <a class="Zooming" href="<?php echo e(url('/login')); ?>">Login</a>
                        <a class="Zooming" href="<?php echo e(url('/register')); ?>">Register</a>
                        <?php else: ?>
                        <a class="Zooming" href="<?php echo e(route('logout')); ?>"
            ...
            <div class="content">
                ...
                <a class="Zooming" href="/showScore/<?php echo e(Auth::user()->email); ?>"> <img class="Zooming" src="/../../storage/Images/ScoreList.png" style="width:65px;height:40px"> View <?php echo e(Auth::user()->name); ?>'s Score</a>
                <?php else: ?>
...
<?php /**PATH C:\Users\ASUS\Desktop\Thesis\resources\views/welcome.blade.php ENDPATH**/ ?>