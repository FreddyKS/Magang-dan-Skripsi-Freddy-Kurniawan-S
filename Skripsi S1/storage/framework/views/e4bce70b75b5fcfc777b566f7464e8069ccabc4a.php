...
unset($__errorArgs, $__bag); ?>" type="text" name="data" placeholder="Insert data into Queue" autofocus Required="True">
...
<?php if(isset($data_structures)): ?>        
    ...
    <table>
        ...
        <?php endif; ?>
            ...
            <?php endif; ?>
            <?php elseif($alert=="Dequeue Success"): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\Thesis\resources\views/queue.blade.php ENDPATH**/ ?>