    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body"style="background: url('/../storage/Images/Background_Image.png') 0 0 no-repeat;">
                    <div class="links">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 7\Thesis\resources\views/queue_homepage.blade.php ENDPATH**/ ?>