...
BUMN : ASDP, PELNI, Pelindo 1, Pelindo 2, Pelindo 3, Pelindo 4
...
<?php
     ...
     $query = "SELECT 'ASDP' AS nama_BUMN, 'dm_pergerakan_kapal_asdp' AS nama_tabel ,  
 CASE
 ...
 FROM " .$database. ".dm_pergerakan_kapal_asdp
UNION ALL
SELECT 'PELNI' AS nama_BUMN, 'dm_pergerakan_kapal_penumpang_pelni' AS nama_tabel ,  
 ...
 count(case when substring(tanggal_origin,6,7)=12 AND substring(tanggal_origin,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_kapal_penumpang_pelni
UNION ALL
SELECT 'PELNI' AS nama_BUMN, 'dm_pergerakan_tol_laut_pelni' AS nama_tabel ,  
 ...
 END AS data_terupdate, CURRENT_DATE() AS tanggal_pengecekan, 
 count(case when substring(tanggal_berangkat,6,7)=1 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Januari_" .$year. ", 
 count(case when substring(tanggal_berangkat,6,7)=2 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Februari_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=3 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Maret_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=4 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS April_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=5 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Mei_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=6 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Juni_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=7 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Juli_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=8 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Agustus_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=9 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS September_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=10 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Oktober_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=11 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal_berangkat,6,7)=12 AND substring(tanggal_berangkat,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_tol_laut_pelni
UNION ALL
SELECT 'Pelindo 1' AS nama_BUMN, 'dm_pergerakan_kapal_pelindo1' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_kapal_pelindo1
UNION ALL
SELECT 'Pelindo 1' AS nama_BUMN, 'dm_pergerakan_nonpetikemas_pelindo1' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_nonpetikemas_pelindo1
UNION ALL
SELECT 'Pelindo 1' AS nama_BUMN, 'dm_pergerakan_penumpanng_pelindo1' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_penumpanng_pelindo1
UNION ALL
SELECT 'Pelindo 1' AS nama_BUMN, 'dm_pergerakan_petikemas_pelindo1' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_petikemas_pelindo1
UNION ALL
SELECT 'Pelindo 2' AS nama_BUMN, 'dm_pergerakan_kapal_pelindo2' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_kapal_pelindo2
UNION ALL
SELECT 'Pelindo 2' AS nama_BUMN, 'dm_pergerakan_nonpetikemas_pelindo2' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_nonpetikemas_pelindo2
UNION ALL
SELECT 'Pelindo 2' AS nama_BUMN, 'dm_pergerakan_penumpanng_pelindo2' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_penumpanng_pelindo2
UNION ALL
SELECT 'Pelindo 2' AS nama_BUMN, 'dm_pergerakan_petikemas_pelindo2' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_petikemas_pelindo2
UNION ALL
SELECT 'Pelindo 3' AS nama_BUMN, 'dm_pergerakan_kapal_pelindo3' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_kapal_pelindo3
UNION ALL
SELECT 'Pelindo 3' AS nama_BUMN, 'dm_pergerakan_nonpetikemas_pelindo3' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_nonpetikemas_pelindo3
UNION ALL
SELECT 'Pelindo 3' AS nama_BUMN, 'dm_pergerakan_penumpanng_pelindo3' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_penumpanng_pelindo3
UNION ALL
SELECT 'Pelindo 3' AS nama_BUMN, 'dm_pergerakan_petikemas_pelindo3' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_petikemas_pelindo3
UNION ALL
SELECT 'Pelindo 4' AS nama_BUMN, 'dm_pergerakan_kapal_pelindo4' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_kapal_pelindo4
UNION ALL
SELECT 'Pelindo 4' AS nama_BUMN, 'dm_pergerakan_nonpetikemas_pelindo4' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_nonpetikemas_pelindo4
UNION ALL
SELECT 'Pelindo 4' AS nama_BUMN, 'dm_pergerakan_penumpanng_pelindo4' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_penumpanng_pelindo4
UNION ALL
SELECT 'Pelindo 4' AS nama_BUMN, 'dm_pergerakan_petikemas_pelindo4' AS nama_tabel ,  
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pergerakan_petikemas_pelindo4";
...
echo "<button onclick=\"location.href='/ScriptDataTerupdate/DataTerupdateTotalRowPerBulanHalaman2.php?year=".$year."&database=".$database."&password=".$_GET['password']."&host=".$host."&user=".$user."&port=".$port."&token=".$_GET['token']."'\" disabled> 2 </button>";
