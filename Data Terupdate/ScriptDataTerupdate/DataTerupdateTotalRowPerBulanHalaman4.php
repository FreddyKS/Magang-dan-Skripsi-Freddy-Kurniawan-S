...
<?php
     ...
     $query = "SELECT 'PLN' AS nama_BUMN, 'dm_pendapatan_Penjualan_pln' AS nama_tabel ,  
 CASE
 ...
 count(case when substring(blnthn,5,6)=12 AND substring(blnthn,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pendapatan_Penjualan_pln
UNION ALL
SELECT 'PLN' AS nama_BUMN, 'dm_pendapatan_Penjualan_pln_copy' AS nama_tabel ,   
 ...
 count(case when substring(blnthn,5,6)=11 AND substring(blnthn,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(blnthn,5,6)=12 AND substring(blnthn,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_pendapatan_Penjualan_pln_copy
UNION ALL
SELECT 'PLN' AS nama_BUMN, 'dm_stimulus_covid19_pln' AS nama_tabel ,   
 ...
 count(case when substring(blnthn,5,6)=11 AND substring(blnthn,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(blnthn,5,6)=12 AND substring(blnthn,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_stimulus_covid19_pln
UNION ALL
SELECT 'PLN' AS nama_BUMN, 'dm_stimulus_covid19_pln_copy' AS nama_tabel ,   
 ...
 count(case when substring(blnthn,5,6)=11 AND substring(blnthn,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(blnthn,5,6)=12 AND substring(blnthn,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_stimulus_covid19_pln_copy
UNION ALL
...
'(tidak ada atribut tanggal)' AS data_terupdate, CURRENT_DATE() AS tanggal_pengecekan, 
 ...
 FROM " .$database. ".dm_tabel_gol_pln
UNION ALL
SELECT 'PLN' AS nama_BUMN, 'insentif_listrik_pln' AS nama_tabel ,  
 ...
 FROM " .$database. ".insentif_listrik_pln WHERE tahun=(SELECT max(tahun) FROM " .$database. ".insentif_listrik_pln)
UNION ALL
SELECT 'PLN' AS nama_BUMN, 'pelanggan_per_segment_pln' AS nama_tabel, 
 ...
 count(case when bulan='November' AND tahun=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when bulan='Desember' AND tahun=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".pelanggan_per_segment_pln WHERE tahun=(SELECT max(tahun) FROM " .$database. ".pelanggan_per_segment_pln)
UNION ALL
SELECT 'PLN' AS nama_BUMN, 'pendapatan_pln' AS nama_tabel ,
 ...
 count(case when bulan='November' AND tahun=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when bulan='Desember' AND tahun=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row 
 FROM " .$database. ".pendapatan_pln WHERE tahun=(SELECT max(tahun) FROM " .$database. ".pendapatan_pln)
UNION ALL
...
SELECT 'Pertamina' AS nama_BUMN, 'data_total_lifting_pertamina' AS nama_tabel ,  
 ...
 FROM " .$database. ".data_total_lifting_pertamina WHERE tahun=(SELECT max(tahun) FROM " .$database. ".data_total_lifting_pertamina)
UNION ALL
SELECT 'Pertamina' AS nama_BUMN, 'data_total_produksi_pertamina' AS nama_tabel ,  
 ...
 '' AS Oktober_" .$year. ",
 '' AS November_" .$year. ",
 '' AS Desember_" .$year. ", '' AS Total_Row 
 FROM " .$database. ".data_total_produksi_pertamina WHERE bulan=(SELECT max(bulan) FROM " .$database. ".data_total_produksi_pertamina WHERE tahun=(SELECT max(tahun) FROM " .$database. ".data_total_produksi_pertamina))
UNION ALL
SELECT 'Pertamina' AS nama_BUMN, 'data_total_produksi_pertamina' AS nama_tabel ,  
 ...
 count(case when bulan=11 AND tahun=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when bulan=12 AND tahun=" .$year. " then 1 else null end) AS Desember_" .$year. ",count(*) AS Total_Row 
 FROM " .$database. ".data_total_produksi_pertamina WHERE tahun=(SELECT max(tahun) FROM " .$database. ".data_total_produksi_pertamina dtpp)
UNION ALL
SELECT 'Pertamina' AS nama_BUMN, 'dm_total_lifting_pertamina' AS nama_tabel , 
 ...
 FROM " .$database. ".dm_total_lifting_pertamina
UNION ALL
SELECT 'Pertamina' AS nama_BUMN, 'dm_total_penjualan_pertamina' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_total_penjualan_pertamina
UNION ALL
SELECT 'Pertamina' AS nama_BUMN, 'dm_total_produksi_pertamina' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_total_produksi_pertamina
UNION ALL
...
echo "<button onclick=\"location.href='/ScriptDataTerupdate/DataTerupdateTotalRowPerBulanHalaman4.php?year=".$year."&database=".$database."&password=".$_GET['password']."&host=".$host."&user=".$user."&port=".$port."&token=".$_GET['token']."'\" disabled> 4 </button>";
