...
BUMN : Garuda, Citilink, Bulog, Mandiri
...
<?php
     ...
     $query = "SELECT 'Garuda' AS nama_BUMN, 'data_airport_cd_garuda' AS nama_tabel , '(tidak ada atribut tanggal)' AS data_terupdate, CURRENT_DATE() AS tanggal_pengecekan, 
 '' AS Januari_" .$year. ", 
 '' AS Februari_" .$year. ",
 '' AS Maret_" .$year. ",
 '' AS April_" .$year. ",
 ...
 FROM " .$database. ".data_airport_cd_garuda
UNION ALL
SELECT 'Garuda' AS nama_BUMN, 'data_garuda' AS nama_tabel ,  
 ...
 count(case when Month=1 AND Year=" .$year. " then 1 else null end) AS Januari_" .$year. ", 
 count(case when Month=2 AND Year=" .$year. " then 1 else null end) AS Februari_" .$year. ",
 count(case when Month=3 AND Year=" .$year. " then 1 else null end) AS Maret_" .$year. ",
 count(case when Month=4 AND Year=" .$year. " then 1 else null end) AS April_" .$year. ",
 count(case when Month=5 AND Year=" .$year. " then 1 else null end) AS Mei_" .$year. ",
 count(case when Month=6 AND Year=" .$year. " then 1 else null end) AS Juni_" .$year. ",
 count(case when Month=7 AND Year=" .$year. " then 1 else null end) AS Juli_" .$year. ",
 count(case when Month=8 AND Year=" .$year. " then 1 else null end) AS Agustus_" .$year. ",
 count(case when Month=9 AND Year=" .$year. " then 1 else null end) AS September_" .$year. ",
 count(case when Month=10 AND Year=" .$year. " then 1 else null end) AS Oktober_" .$year. ",
 count(case when Month=11 AND Year=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when Month=12 AND Year=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".data_garuda WHERE Year=(SELECT max(Year) FROM " .$database. ".data_garuda)
UNION ALL
SELECT 'Garuda' AS nama_BUMN, 'dm_cargo_garuda' AS nama_tabel , 
 ...
 END AS data_terupdate, CURRENT_DATE() AS tanggal_pengecekan, 
 count(case when substring(date_insert,6,7)=1 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Januari_" .$year. ", 
 count(case when substring(date_insert,6,7)=2 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Februari_" .$year. ",
 count(case when substring(date_insert,6,7)=3 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Maret_" .$year. ",
 count(case when substring(date_insert,6,7)=4 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS April_" .$year. ",
 count(case when substring(date_insert,6,7)=5 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Mei_" .$year. ",
 count(case when substring(date_insert,6,7)=6 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Juni_" .$year. ",
 count(case when substring(date_insert,6,7)=7 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Juli_" .$year. ",
 count(case when substring(date_insert,6,7)=8 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Agustus_" .$year. ",
 count(case when substring(date_insert,6,7)=9 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS September_" .$year. ",
 count(case when substring(date_insert,6,7)=10 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Oktober_" .$year. ",
 count(case when substring(date_insert,6,7)=11 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(date_insert,6,7)=12 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_cargo_garuda
UNION ALL
SELECT 'Garuda' AS nama_BUMN, 'dm_cargo_garuda_copy' AS nama_tabel , 
 ...
 count(case when substring(date_insert,6,7)=11 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(date_insert,6,7)=12 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_cargo_garuda_copy
UNION ALL
SELECT 'Garuda' AS nama_BUMN, 'dm_passenger_garuda' AS nama_tabel , 
 ...
 count(case when substring(date_insert,6,7)=11 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(date_insert,6,7)=12 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_passenger_garuda
UNION ALL
SELECT 'Garuda' AS nama_BUMN, 'dm_passenger_garuda_copy' AS nama_tabel , 
 ...
 count(case when substring(date_insert,6,7)=11 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(date_insert,6,7)=12 AND substring(date_insert,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_passenger_garuda_copy
UNION ALL
SELECT 'Garuda' AS nama_BUMN, 'garuda_indonesia' AS nama_tabel ,  
 CASE
  ...
  ELSE max(date)
 END AS data_terupdate, CURRENT_DATE() AS tanggal_pengecekan, 
 count(case when substring(date,6,7)=1 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Januari_" .$year. ", 
 count(case when substring(date,6,7)=2 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Februari_" .$year. ",
 count(case when substring(date,6,7)=3 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Maret_" .$year. ",
 count(case when substring(date,6,7)=4 AND substring(date,1,4)=" .$year. " then 1 else null end) AS April_" .$year. ",
 count(case when substring(date,6,7)=5 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Mei_" .$year. ",
 count(case when substring(date,6,7)=6 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Juni_" .$year. ",
 count(case when substring(date,6,7)=7 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Juli_" .$year. ",
 count(case when substring(date,6,7)=8 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Agustus_" .$year. ",
 count(case when substring(date,6,7)=9 AND substring(date,1,4)=" .$year. " then 1 else null end) AS September_" .$year. ",
 count(case when substring(date,6,7)=10 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Oktober_" .$year. ",
 count(case when substring(date,6,7)=11 AND substring(date,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(date,6,7)=12 AND substring(date,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".garuda_indonesia
UNION ALL
SELECT 'Citilink' AS nama_BUMN, 'dm_cargo_citilink' AS nama_tabel ,  
 ...
 count(case when substring(tanggal_departure,6,7)=12 AND substring(tanggal_departure,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_cargo_citilink
UNION ALL
SELECT 'Citilink' AS nama_BUMN, 'dm_passenger_citilink' AS nama_tabel ,  
 ...
 count(case when substring(tanggal_departure,6,7)=11 AND substring(tanggal_departure,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal_departure,6,7)=12 AND substring(tanggal_departure,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_passenger_citilink
UNION ALL
SELECT 'Bulog' AS nama_BUMN, 'data_serapan_bulog' AS nama_tabel ,  
 ...
 FROM " .$database. ".data_serapan_bulog
UNION ALL
...
SELECT 'Bulog' AS nama_BUMN, 'dm_bansos_covid_bulog' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_bansos_covid_bulog
UNION ALL
SELECT 'Bulog' AS nama_BUMN, 'dm_bansos_kemensos_bulog' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_bansos_kemensos_bulog
UNION ALL
SELECT 'Bulog' AS nama_BUMN, 'dm_serapan_petani_bulog' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_serapan_petani_bulog
UNION ALL
SELECT 'Bulog' AS nama_BUMN, 'dm_stok_cbp_bulog' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_stok_cbp_bulog
UNION ALL
SELECT 'Bulog' AS nama_BUMN, 'program_penyerapan_beras_bulog' AS nama_tabel , 
 ...
 FROM " .$database. ".program_penyerapan_beras_bulog WHERE tahun=(SELECT max(tahun) FROM " .$database. ".program_penyerapan_beras_bulog)
UNION ALL
SELECT 'Bulog' AS nama_BUMN, 'stock_bulog' AS nama_tabel ,
 ...
 count(case when bulan='November' AND tahun=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when bulan='Desember' AND tahun=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".stock_bulog WHERE tahun=(SELECT max(tahun) FROM " .$database. ".stock_bulog)
UNION ALL
SELECT 'Mandiri' AS nama_BUMN, 'dm_bunga_kur_nonkur_mandiri' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_bunga_kur_nonkur_mandiri
UNION ALL
SELECT 'Mandiri' AS nama_BUMN, 'dm_bunga_kur_nonkur_mandiri_copy' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_bunga_kur_nonkur_mandiri_copy
UNION ALL
SELECT 'Mandiri' AS nama_BUMN, 'dm_penempatan_dana_pmk70_mandiri' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_penempatan_dana_pmk70_mandiri
UNION ALL
SELECT 'Mandiri' AS nama_BUMN, 'dm_penempatan_dana_pmk70_mandiri_copy' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_penempatan_dana_pmk70_mandiri_copy
UNION ALL
SELECT 'Mandiri' AS nama_BUMN, 'dm_renc_realisasi_dana_pmk70_mandiri' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_renc_realisasi_dana_pmk70_mandiri
UNION ALL
SELECT 'Mandiri' AS nama_BUMN, 'dm_renc_realisasi_dana_pmk70_mandiri_copy' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_renc_realisasi_dana_pmk70_mandiri_copy";
...
echo "<button onclick=\"location.href='/ScriptDataTerupdate/DataTerupdateTotalRowPerBulanHalaman7.php?year=".$year."&database=".$database."&password=".$_GET['password']."&host=".$host."&user=".$user."&port=".$port."&token=".$_GET['token']."'\" disabled> 7 </button>";
