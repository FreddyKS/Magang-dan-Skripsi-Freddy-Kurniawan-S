...
<?php
    $mysqli = new mysqli($HOST, $user, $password);
     ...
     $query = "SELECT 'BNI' AS nama_BUMN, 'bank_bni' AS nama_tabel , 
 CASE
...
SELECT 'BNI' AS nama_BUMN, 'bank_bni_proyeksi' AS nama_tabel , 
 CASE
  ...
  ELSE max(timestamp)
 END AS data_terupdate, CURRENT_DATE() AS tanggal_pengecekan, 
 count(case when substring(timestamp,6,7)=1 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Januari_" .$year. ", 
 count(case when substring(timestamp,6,7)=2 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Februari_" .$year. ",
 count(case when substring(timestamp,6,7)=3 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Maret_" .$year. ",
 count(case when substring(timestamp,6,7)=4 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS April_" .$year. ",
 count(case when substring(timestamp,6,7)=5 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Mei_" .$year. ",
 count(case when substring(timestamp,6,7)=6 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Juni_" .$year. ",
 count(case when substring(timestamp,6,7)=7 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Juli_" .$year. ",
 count(case when substring(timestamp,6,7)=8 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Agustus_" .$year. ",
 count(case when substring(timestamp,6,7)=9 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS September_" .$year. ",
 count(case when substring(timestamp,6,7)=10 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Oktober_" .$year. ",
 count(case when substring(timestamp,6,7)=11 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(timestamp,6,7)=12 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".bank_bni_proyeksi
UNION ALL
SELECT 'BNI' AS nama_BUMN, 'dm_bunga_kur_nonkur_bni' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_bunga_kur_nonkur_bni
UNION ALL
SELECT 'BNI' AS nama_BUMN, 'dm_bunga_kur_nonkur_bni_copy' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_bunga_kur_nonkur_bni_copy
UNION ALL
SELECT 'BNI' AS nama_BUMN, 'dm_penempatan_dana_pmk70_bni' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_penempatan_dana_pmk70_bni
UNION ALL
SELECT 'BNI' AS nama_BUMN, 'dm_penempatan_dana_pmk70_bni_copy' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_penempatan_dana_pmk70_bni_copy
UNION ALL
SELECT 'BNI' AS nama_BUMN, 'dm_renc_realisasi_dana_pmk70_bni' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_renc_realisasi_dana_pmk70_bni
UNION ALL
SELECT 'BNI' AS nama_BUMN, 'dm_renc_realisasi_dana_pmk70_bni_copy' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_renc_realisasi_dana_pmk70_bni_copy
UNION ALL
SELECT 'BTN' AS nama_BUMN, 'dm_bunga_kur_nonkur_btn' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_bunga_kur_nonkur_btn
UNION ALL
SELECT 'BTN' AS nama_BUMN, 'dm_penempatan_dana_pmk70_btn' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_penempatan_dana_pmk70_btn
UNION ALL
SELECT 'BTN' AS nama_BUMN, 'dm_renc_realisasi_dana_pmk70_btn' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_renc_realisasi_dana_pmk70_btn
UNION ALL
SELECT 'BTN' AS nama_BUMN, 'dm_renc_realisasi_dana_pmk70_btn_copy' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_renc_realisasi_dana_pmk70_btn_copy
UNION ALL
...
SELECT 'BRI' AS nama_BUMN, 'bank_bri_proyeksi' AS nama_tabel , 
 ...
 count(case when substring(timestamp,6,7)=11 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(timestamp,6,7)=12 AND substring(timestamp,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".bank_bri_proyeksi
UNION ALL
SELECT 'BRI' AS nama_BUMN, 'dm_bunga_kur_nonkur_bri' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_bunga_kur_nonkur_bri
UNION ALL
SELECT 'BRI' AS nama_BUMN, 'dm_penempatan_dana_pmk70_bri' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_penempatan_dana_pmk70_bri
UNION ALL
SELECT 'BRI' AS nama_BUMN, 'dm_renc_realisasi_dana_pmk70_bri' AS nama_tabel , 
 ...
 count(case when substring(tanggal,6,7)=11 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS November_" .$year. ",
 count(case when substring(tanggal,6,7)=12 AND substring(tanggal,1,4)=" .$year. " then 1 else null end) AS Desember_" .$year. ", count(*) AS Total_Row
 FROM " .$database. ".dm_renc_realisasi_dana_pmk70_bri";
...
echo "<button onclick=\"location.href='/ScriptDataTerupdate/DataTerupdateTotalRowPerBulanHalaman8.php?year=".$year."&database=".$database."&password=".$_GET['password']."&host=".$host."&user=".$user."&port=".$port."&token=".$_GET['token']."'\" disabled> 8 </button>";
$mysqli -> close();
?>
</center>
</body>
